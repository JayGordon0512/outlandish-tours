// components/admin/NewOptionForm.tsx
"use client";
...
export function NewOptionForm() {
  const router = useRouter();
  const [name, setName] = useState("");
  const [description, setDescription] = useState("");
  const [price, setPrice] = useState<number | "">("");
  const [chargeType, setChargeType] = useState<ChargeType>("PER_PERSON");
    ...
    >
      <div className="space-y-1">
        ...
        <input
          ...
          placeholder="Accommodation, Airport pickup, Private guide…"
        />
      </div>
      ...
      <div className="space-y-1">
        ...
        <textarea
          ...
          placeholder="E.g. 3* hotel, twin share, breakfast included."
        />
      </div>
      ...
      <div className="flex items-center gap-2 text-xs">
        ...
        <label htmlFor="isActive" className="text-highland-ink">
          Option is active (available to add to tours)
        </label>
      </div>
